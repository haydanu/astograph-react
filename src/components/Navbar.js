  ...
  return (
    <div>
      <Navbar className='navbar' expand='md'>
        <NavbarBrand href='https://www.stellarx.com'>
          <svg
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className='ml-auto' navbar>
            <NavItem>
              <a
                href='https://stellarxsupport.zendesk.com/hc/en-us'
                target='_blank'
                rel='noopener noreferrer'>
                Support
              </a>
            ...
            <NavItem>
              <NavLink to='/about'>LOG IN</NavLink>
            </NavItem>
            <NavItem>
